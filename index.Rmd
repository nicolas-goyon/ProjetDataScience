...
Avec ces Anova on peut définir que toutes les variables testés ne sont pas indépendante au salaire.
...
En résumé, voici les critères qui influent sur le salaire, classés du plus impactant au moins impactant :
1. Pays d'accueil
2. Filière
3. Type de contrat
4. Type de formation/Genre
...
Par la suite, nous sommes passés à la phase d'harmonisation des données, où de nouveaux problèmes ont émergé. En premier lieu, il était nécessaire de déterminer comment harmoniser les colonnes, puis de normaliser les valeurs. Il fallait veiller à ce que, d'un fichier à l'autre, deux valeurs signifiant la même chose soient strictement équivalentes, afin d'élaborer un script unique pour l'analyse des données. Malgré nos efforts, la coordination des valeurs d'harmonisation a posé problème, laissant nos fichiers CSV partiellement non harmonisés à ce jour.
...
Assia :
- Harmonisation d'une partie des données.
- Modification du script final pour diversifier les diagrammes et les rendre plus esthétiques et accessibles.
